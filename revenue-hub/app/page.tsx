...
function BottomNav({ activeView, allChats, onSelect }: {
  ...
  return (
    <div style={{ position: 'fixed', left: 0, right: 0, bottom: 0, zIndex: 80, background: SURFACE, borderTop: `1px solid ${BORDER}`, paddingTop: 6, paddingBottom: 0, flexShrink: 0, overflowX: 'auto', WebkitOverflowScrolling: 'touch' } as React.CSSProperties}>
...
export default function Page() {
  ...
  if (isMobile) {
    const shell = (content: React.ReactNode) => (
      <div style={{ display: 'flex', flexDirection: 'column', height: '100dvh', background: BG, overflow: 'hidden', paddingBottom: 64, boxSizing: 'border-box' }}>
        {content}
